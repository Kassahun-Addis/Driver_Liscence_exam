...
if($result->num_rows>0)
{
    ...
    <td>'.$row["time"].' min</td>
    <td><a class="btn btn-secondary" href="quizquestion.php?q=quizquestion.php&eid='.$eid.'&tabelname='.$tabelname.'&total='.$total.'">Start</a>
    <a class="btn btn-secondary mt-1" href="update.php?q=deleteqns&title='.$title.'"><i class="fas fa-trash"></i></a></td>
    </tr>';
    }
   echo' <tbody> </table>';
}
